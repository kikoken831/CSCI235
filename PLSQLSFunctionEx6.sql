create or replace function displayNationByRegionSFEx6 ( regionName REGION.r_name%type ) 
return varchar2
is
...
begin
  ...
  loop
    ...
    --
    res := trim(res) || chr(9) || lpad(QRow.n_nationkey,10) || chr(9) || trim(QRow.n_name) || chr(10);
    --
  end loop;
  --
  return trim(res);
