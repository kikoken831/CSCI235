...
--
procedure displayCustomerByMktSegment(marketSegment CUSTOMERTEST.c_mktsegment%type) is
...
--
begin -- Begin of PL/SQL block
  myMarketSegment := '&myMarketSegment';
  displayCustomerByMktSegment(myMarketSegment);
end;
/
show errors
