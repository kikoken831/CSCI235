declare
-- Declaration of variables used in the block
myMarketSegment	CUSTOMERTEST.c_mktsegment%type;
-- 
-- procedure declaration
procedure dispCustomerByNation(marketSegment CUSTOMERTEST.c_mktsegment%type) is
...
begin
   ...
   dispCustomerByNation(myMarketSegment);
end;
/
show errors
