...
-- Declaration
declare
   -- Declare all required variables/procedures/functions here...
regionName	REGIONTEST.r_name%type;
--
function dispNationByRegionFEx5(regionName REGIONTEST.r_name%type) 
return varchar2
is
-- Declarion
...
END;
--
begin -- Begin of executable block
   regionName := '&regionName';
   dbms_output.put_line(dispNationByRegionFEx5(regionName));
